...
public class CcaScoreSummaryDto {
	...
	public void setStudentScores(List<CcaCompScoreDto> studentScores) {
		this.studentScores = studentScores;
	}

	public List<CcaCompScoreDto> getDeptAvgScores() {
		return deptAvgScores;
	}

	public void setDeptAvgScores(List<CcaCompScoreDto> deptAvgScores) {
		this.deptAvgScores = deptAvgScores;
	}

	public List<CcaCompScoreDto> getOverallAvgScores() {
		return overallAvgScores;
	}

	public void setOverallAvgScores(List<CcaCompScoreDto> overallAvgScores) {
		this.overallAvgScores = overallAvgScores;
	}
